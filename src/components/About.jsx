    ...
    return (
     ...
     <div className="program-row">
       ...
       <div className="program-image">
         <img src="https://pinchofyum.com/wp-content/assets/images/about/lindsay-hero.jpg" alt="Program 1" className="program-img" />
       </div>
...
I live in Saint Paul, MN with my husband Bjork and our dog Sage. My favorite things in life are a big plate of pad Thai, sunny days, and going to the dog park.</p>
       </div>
     </div>
     ...
     <div className="program-row">
       ...
       <div className="program-text">
         <h2>Prevent Diabetes Culinary Program</h2>
        <p>The prevent diabetes culinary program is a 2-6 month virtual or in-person program aimed to prevent diabetes in participants of African descent. The program is a combination of nutrition education and culinary classes preparing culture-focused recipes.
This program increases the consumption of fruit, vegetables, lean protein, and whole grains with applicable lifestyle changes and habits. In this program, we offer step-by-step education on how to properly select, cook, and store produce while maintaining its nutrients and providing optimal nutritional value. Each group is also taught about stress management, a grocery store tour, physical activity, and tracking intake. Through our interactive classes, participants will learn practical skills, such as proper meal planning, healthy cooking techniques, and portion control, adapting traditional recipes to be more health-conscious, providing tips and tricks for maximizing nutrition without compromising flavor.</p>
       </div>

       
       <div className="program-image">
         <img src="https://cdn.prod.website-files.com/5e86c7170f1ab21474c3f2a4/5ef1d04b4056011f67df2ed7_Natural%2Blight%2B-%2BFood%2BPhotography%2B-%2BFrenchly%2B-4365.jpg" alt="Program 2" className="program-img" />
       </div>
     </div>
     <div className="program-row">
      
      <div className="program-image">
        <img src="https://www.fda.gov/files/9-Major-Food-Allergens_0.png" alt="Program 1" className="program-img" />
      </div>
...
This program equips participants with the knowledge to provide culturally sensitive nutrition recommendations, develop personalized plans, and support clients in achieving their health goals while respecting their cultural identity.</p>
      </div>

      
      <div className="program-image">
        <img src="https://food-guide.canada.ca/themes/custom/wxtsub_bootstrap/images/food_guide_visual_en.png" alt="Program 2" className="program-img" />
      </div>
    </div>
    <div className="program-row">
      
      <div className="program-image">
        <img src="https://static.vecteezy.com/system/resources/previews/024/841/278/non_2x/fresh-food-in-human-body-nutrition-for-human-human-body-made-of-vegetable-and-fruits-isolated-on-transparent-background-healthy-food-concept-generative-ai-free-png.png" alt="Program 1" className="program-img" />
      </div>
